...
class Topic(models.Model):
    '''单位工程名称'''
    text = models.CharField(max_length=200, verbose_name='工程名称')
    date_added = models.DateField(default=timezone.localdate())
    company = models.ForeignKey(Group, on_delete=models.CASCADE, verbose_name='单位名称')
    owner = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='管理员')
    '''增加单位工程属性'''
    quantity = models.FloatField(default=0, verbose_name='工程量')
...
class Entry(models.Model):
    ...
    date_added = models .DateField(default=timezone.localdate(),verbose_name='施工日期')
    '''增加日报细分内容'''
    worker = models.IntegerField(default=0,verbose_name='出勤人数')
    ...
    cement = models.FloatField(default=0,verbose_name='水泥量')
